...
booking_c = Booking.create(user: user_i, profile: profile_i, event_name: "Acapella signing competition", event_location: "London Theather", start_date: start_date_3, end_date: end_date_3)
